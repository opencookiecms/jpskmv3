									...
									<div class="col-xl-3 col-lg-3 col-md-12">
										<div class="card">
											<div class="card-body">
												...
												<p class=" mb-1 ">Jumlah Kontraktor</p>
											...
											<table id="example1" class="table table-striped table-bordered text-nowrap" style="width:100%">
												<thead>
													<tr class="bold">
														...
														<th class="border-bottom-0">Nama Syarikat</th>
														<th class="border-bottom-0">Nama Pengurus</th>
														<th class="border-bottom-0">No Telefon</th>
