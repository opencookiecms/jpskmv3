                    ...
                    <div class="box-widget widget-user">
                        <div class="widget-user-image d-sm-flex">
                            <img alt="User Avatar" class="rounded-circle border p-0"
                                src="<?php echo base_url() ?>assets/userimage/<?php echo $kdetail[0]->konImage ?>"
                                style="width:200px; height:200px;">
                            <div class="ml-sm-4 mt-4">
                                <h4 class="pro-user-username mb-3 font-weight-bold"><?php echo $kdetail[0]->konName ?>
                                </h4>
                                <div class="d-flex mb-1">
                                    ...
                                    <div class="h6 mb-0 ml-3 mt-1">
                                        <?php echo $kdetail[0]->KonAlamat ?></br><?php echo $kdetail[0]->konAlamatExtS ?><?php echo $kdetail[0]->konAlamatExtD ?></br><?php echo $kdetail[0]->konPoskod ?>
                                        <?php echo $kdetail[0]->konBandar ?>
                                        <?php echo $kdetail[0]->konDaerah?></br><?php echo $kdetail[0]->konNegeri ?>
                                    </div>
                                </div>
                                <div class="d-flex mb-1">
                                    <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-center border p-3 mb-3 br-7">
                                            <div class="box-widget widget-user">
                                                <div class="widget-user-image d-sm-flex">
                                                    <div class="ml-sm-4 mt-4">
                                                        <h4 class="pro-user-username mb-3 font-weight-bold">Rakan Kongsi
                                                            <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 24 24" fill="black" width="20px"
                                                                height="20px">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <td colspan="9" class="bg-primary text-white">Status Pendaftaran Syarikat<br>
                                        </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="9" class="tg-yw4l"><?php echo $kdetail[0]->spStatusSijil ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" class="bg-primary text-white">1) Lembaga Pembangunan
                                                Industri Pembinaan Malaysia (LPIPM)</td>
                                        </tr>
                                        <tr>
                                            <td class="tg-9hbo" colspan="10">a) Sijil Perakuan Pendaftaran Kontraktro
                                                (PPK)</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th>Pengkususan</th>
                                            <td colspan="5" class="tg-yw4l"><?php echo $kdetail[0]->sijilPPKKhuOne ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Gred_1_2</th>
                                            ...
                                            <th>Pengkususan</th>
                                            <td colspan="5" class="tg-yw4l"><?php echo $kdetail[0]->sijilPPKKhuTwo ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Gred_1_3</th>
                                            ...
                                            <th>Pengkususan</th>
                                            <td colspan="5" class="tg-yw4l"><?php echo $kdetail[0]->sijilPPKKhuThree ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tg-9hbo" colspan="10">b) Sijil Perolehan Kerja Kerajaan (SPKK)
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th>Pengkususan</th>
                                            <td colspan="5" class="tg-yw4l"><?php echo $kdetail[0]->sijilSPPKKhuOne ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Gred_2_2</th>
                                            ...
                                            <th>Pengkususan</th>
                                            <td colspan="5" class="tg-yw4l"><?php echo $kdetail[0]->sijilSPPKKhuTwo ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Gred_2_3</th>
                                            ...
                                            <th>Pengkususan</th>
                                            <td colspan="5" class="tg-yw4l"><?php echo $kdetail[0]->sijilSPPKKhuThree ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="9" class="bg-primary text-white">2) Pusat Khidmat Kontraktor
                                                (PPK)</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="tg-9hbo" colspan="10">a) Sijil Perakuan Pendaftaran
                                                Pembekal/Kontraktor(SPPPK)</td>
                                        </tr>
                                        <tr>
                                            <th>No Pendaftaran</th>
