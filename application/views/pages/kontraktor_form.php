										...
										<div id="wizard1" class="p-4">
											...
											<div class="row">
												...
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<input class="form-control" placeholder="cth:010-1234567" type="text"  name="noktelefonpengurus">
													</div>
												</div>
												<div class="col-sm-6 col-md-6"></div>
												<div class="col-sm-6 col-md-6">
												...
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<input class="form-control" placeholder="cth:010-1234567" type="text"  name="faxsyarikat">
													</div>
												</div>
											...
											<section>
												<div class="form-group">
													...
													<input type="text" class="form-control" id="name1" placeholder="cth:Maybank, RHB Bank, CIMB Bank" name="namabank">
												</div>
												<div class="form-group">
													<label class="form-label">No Akaun</label>
													<div class="input-group">
														<input type="text" class="form-control" placeholder="Akaun bank terkini" name="noakaun">
