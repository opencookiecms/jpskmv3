    ...
    <div class="container">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                <h4 class="page-title">Aduan Dashboard</h4>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <svg class="card-custom-icon text-success icon-dropshadow-success" x="1008" y="1248"
                                    viewBox="0 0 24 24" fit="" height="100%" width="100%"
                                ...
                                <h2 class="mb-1 font-weight-bold"><?php echo $get_count ?></h2>
									...
									<div class="col-xl-3 col-lg-3 col-md-12">
										<div class="card">
											<div class="card-body">
												...
												<p class=" mb-1 ">Tidak Berdaftar</p>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-options">
                            <div class="btn-group ml-5 mb-0">
                                <a href="<?php echo site_url('aduan/b-aduan-satu')?>" class="btn btn-success"><i
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example1" class="table table-striped table-bordered text-nowrap"
                                ...
                                <thead>
                                    <tr class="bold">
                                        <th class="border-bottom-0">Bil#</th>
                                        <th class="border-bottom-0">Nama Pengadu</th>
                                        <th class="border-bottom-0">Daerah</th>
                                        <th class="border-bottom-0">Tel No</th>
                                        <th class="border-bottom-0">Aduan</th>
                                        <th class="border-bottom-0">Tarikh</th>
                                        <th class="border-bottom-0">Status</th>
                                        <th class="text-center border-bottom-0">Tindakan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $bil=0;?>
                                    <?php foreach ($get_aduan as $row): $bil++?>
