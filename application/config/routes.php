...
*/
$route['default_controller'] = 'Kontraktorcontroller';
...
$route['aduan/b-aduan-dua/(:num)'] = "Aduancontroller/addAduan2/$1";
$route['aduan/b-aduan-tiga/(:num)'] = "Aduancontroller/addAduan3/$1";
